        ...
        function makeLinksClickable(text) {
            ...
            return text.replace(urlRegex, url => {
                ...
                if (ytMatch) {
                    ...
                    return `
            <div style="margin-top:4px; display:flex; flex-direction:column; align-items:flex-start;">
                <iframe
                    src="${embedUrl}"
                    frameborder="0"
                    ...
                    style="
                        ...
                        vertical-align:top;
                    "></iframe>
                <a href="${href}" target="_blank" rel="noopener noreferrer" style="font-size:0.85em; color:#66b3ff; margin-top:2px;">🔗</a>
            </div>`;
                }
                ...
                if (/\.(png|jpe?g|gif|webp|bmp|svg)$/i.test(href)) {
                    return `
            <div style="display:inline-flex; flex-wrap:wrap; align-items:flex-start; gap:6px; padding-top:2px; vertical-align:top;">
                <img src="${href}"
                     loading="lazy"
                     class="neko-chat-img"
                     style="
                ...
                <a href="${href}" target="_blank" rel="noopener noreferrer"
                   style="flex-shrink:0; color:#66b3ff; font-size:14px; text-decoration:none; white-space:nowrap;">🔗</a>
            </div>`;
                }

                // Обычная ссылка или текст
                return `<div style="margin-top:2px;">${url.startsWith('http') ? `<a href="${href}" target="_blank" rel="noopener noreferrer" style="color:#66b3ff; text-decoration:underline;">${url}</a>` : url}</div>`;
            });
        }
